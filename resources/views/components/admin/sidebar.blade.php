...
<div class="bg-cardbgalt border border-black flex flex-col p-4 gap-2">
    <div class="flex flex-col">
        ...
        <a href="/admin/users" class="border-l-2 px-1 {{ activeOrNot('admin.users') }}">
            <span>Users</span>
        </a>
        <a href="/admin/roles" class="border-l-2 px-1 {{ activeOrNot('admin.roles') }}">
            <span>Roles</span>
        </a>
    </div>
    ...
    <div class="flex flex-col">
        ...
        <a href="/admin/sites" class="border-l-2 px-1 {{ activeOrNot('admin.sites') }}">
            <span>Sites</span>
        </a>
    </div>
</div>
